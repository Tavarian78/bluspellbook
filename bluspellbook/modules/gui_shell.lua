        ...
        imgui.Separator();
            ...
            if (state.active_tab == 3) then
                ...
                if (imgui.CollapsingHeader('Menu Behavior')) then
                    ...
                    imgui.TextWrapped('Hides for game menus except the Blue Magic spell-setting screen and the lower-left Attack, Magic, Abilities, Items, and Disengage command menu.');
                end
