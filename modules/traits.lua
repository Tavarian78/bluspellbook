...
local traits = {
    ...
    { 'Auto Refresh', 48, 'Stinking Gas (1), Geist Wall (1), Cold Wave (1), Blood Saber (2), Self-Destruct (2), Frightful Roar (2), Winds of Promyvion (2), Light of Penance (3), Voracious Trunk (3), Actinic Burst (4), Plasma Charge (4)', { 2 } },
