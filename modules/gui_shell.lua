...
local function draw_window()
    ...
    local window_width = main_window_collapsed and 280 or 900;
    imgui.SetNextWindowSize({ window_width * scale, 520 * scale });
